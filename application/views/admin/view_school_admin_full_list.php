       ...
       <div class="row col-md-12">
            <ul class="nav nav-pills">
                ...
                <li class="dropdown active">
                    ...
                    <li class="active"><a href="<?= base_url('admin/view_school_admin_full_list') ?>">School Admin Full List</a></li>
                    <li class="divider"></li>
                    <li><a href="#">More</a></li>
                    </ul>
                </li>
				...
				<table id="example" class="table table-bordered table-hover" cellspacing="0" width="100%">
					...
					<tbody>
							...
							<tr class="gradeX">
								...
								<td>
									<form style="display:inline-block;" method="post" action="<?php echo base_url('admin/delete_sadmin')?>">
										  <input type="hidden" name="sa_id" value="<?php echo isset($admin->sa_id) ? $admin->sa_id : '' ?>">
